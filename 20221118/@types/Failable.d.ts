...
// 생성을 할때 T에 타입을 전달해주면 그 타입으로 value의 타입이 정해진다.

// function B() : A<String> {
//     return { value : "sdfsdfsd"}
// }
...
// 그래서 함수의 반환타입으로 생성할때 T에 String 그리고 S에 number 타입을 전달하고 생성 해줌으로서
// 함수가 반환하는 타입이 두가지가 될수 있다. 객체 안에 value의 타입이 문자 타입과 숫자 타입 두가자
// 타입을 가지고 반환 할수 있다.